...
const getUserCounts = async (req, res) => {
  try {
    ...
    let closedInvestmentOptions = { userId: user.id, status: "closed" };
    if (business) {
    ...
    const investorClosedBusinessInvestmentRequests =
      await BusinessInvestmentRequest.count({
    ...
    successResponse(res, {
      ...
      myInvestors,
      investorsInterested,
      investmentsMade: investmentsMade || 0,
      enterprenuersInterested,
      videos,
      documents,
      investors: investors,
      reviewers: reviewers,
