...
const { createBusiness, getCategories, updateBusiness, deleteBusiness, getUserBusiness, getAllBusiness, getSellersApplications, getWaitingBusinesses, findBusiness, getApprovedBusinesses, getRejectedBusinesses } = require('./business.controller');
